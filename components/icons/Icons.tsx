...
export const OverdueIcon: React.FC = () => (
...
export const FocusHeaderIcon: React.FC<{className?: string}> = ({ className = "w-7 h-7" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 12c0-2.21 2.239-4 5-4s5 1.79 5 4M7 16c0-2.21 2.239-4 5-4s5 1.79 5 4" />
    </svg>
);
...
export const MomentsIcon: React.FC = () => (
    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const SettingsHeaderIcon: React.FC<{className?: string}> = ({ className = "w-7 h-7" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0h9.75" />
    </svg>
);

export const AddTaskMenuIcon: React.FC<{className?: string}> = ({ className = "w-6 h-6 text-blue-600" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const RegenerateIcon: React.FC = () => (
    <svg className="w-5 h-5 text-blue-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4.06189 15.9381C2.96189 14.2881 2.65189 12.2881 3.22189 10.4581C3.79189 8.62808 5.18189 7.11808 6.99189 6.29808C8.80189 5.47808 10.8819 5.44808 12.7219 6.21808C14.5619 6.98808 16.0319 8.49808 16.8219 10.3281" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M17 6.00008V10.0001H21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M19.9381 8.06195C21.0381 9.71195 21.3481 11.712 20.7781 13.542C20.2081 15.372 18.8181 16.882 17.0081 17.702C15.1981 18.522 13.1181 18.552 11.2781 17.782C9.43811 17.012 7.96811 15.502 7.17811 13.672" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M7 18V14H3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
...
export const PlusIconHeader: React.FC = () => (
    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={4}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m6-6H6" />
    </svg>
);

export const GroceryIcon: React.FC = () => (
    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l1.823-6.831A1.125 1.125 0 0018.102 6H4.227a1.125 1.125 0 00-1.121 1.243l1.823 6.831zM12 18a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm-3 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm6 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
    </svg>
);
...
export const ChevronRightElegantIcon: React.FC<{className?: string}> = ({className}) => (
...
export const AddListMenuIcon: React.FC<{className?: string}> = ({ className = "w-6 h-6 text-blue-600" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
        <path d="M11 12H3" />
        <path d="M16 6H3" />
        <path d="M16 18H3" />
...
export const PaletteIcon: React.FC<{className?: string}> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.098 19.902a3.75 3.75 0 005.304 0l6.401-6.402a3.75 3.75 0 00-5.304-5.304L4.098 14.6c-1.455 1.455-.432 4.02.998 5.304z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const VibrateIcon: React.FC<{className?: string}> = ({ className = "w-6 h-6" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18h3m-3-9h3m-3-3h3" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25c.621 0 1.125.504 1.125 1.125v3.375c0 .621-.504 1.125-1.125 1.125" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 8.25c-.621 0-1.125.504-1.125 1.125v3.375c0 .621.504 1.125 1.125 1.125" />
    </svg>
);
