...
const SettingsToggleItem: React.FC<{
  ...
  >
    <div className="flex items-center gap-4">
        {icon && <div className="w-7 h-7 flex items-center justify-center bg-gray-100 rounded-lg text-gray-600">{icon}</div>}
        <div>
    ...
    <button
        aria-hidden="true"
        className={`relative inline-flex items-center h-7 w-12 rounded-full transition-colors ${enabled ? 'bg-blue-600' : 'bg-gray-200'}`}
    >
